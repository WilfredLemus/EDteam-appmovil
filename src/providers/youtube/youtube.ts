...
export class YoutubeProvider {
  ...
  urlDown = "https://helloacm.com/api/video/?cached&lang=en&hash=19d647bc654361d575806ddaee953487&video=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3D";
  ...
  getVideoDownload(videoId) {
    return this.http.get(this.urlDown + videoId).map(res => {
      return res.json();
    });
  }
